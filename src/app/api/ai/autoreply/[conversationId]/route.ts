 ...
 *                     `last_reviewed_by` (migration
 *                     20260914141753_conversation_supervision_queue) so
 *                     the conversation leaves the "Sem supervisão" queue.
 ...
 *                     handoff auto-assignment (auto-reply.ts,
 *                     `config.handoffAgentId`) is a separate,
 *                     system-triggered code path and must NOT count as
 *                     human review.
